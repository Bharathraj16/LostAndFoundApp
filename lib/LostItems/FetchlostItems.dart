...
class _FetchlostState extends State<Fetchlost> with SingleTickerProviderStateMixin {
  final CollectionReference Lost_items =
  ...
  bool _matchesDateFilter(DocumentSnapshot document) {
    try {
      ...
      if (document['Mising Date'] == null) return false;

      final storedDateStr = document['Mising Date'].toString().trim();
              ...
              Padding(
                ...
                child: Text(
                  _searchQuery.isNotEmpty ||
                      ...
                      : 'Check back later for reported lost items',
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                document['Mising Date'] ?? 'Unknown date',
                                style: Theme.of(context).textTheme.bodySmall,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                              ),
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: () => _contactOwner(document),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.grey.shade900,
                            foregroundColor: Colors.white,
  ...
  Future<void> _contactOwner(DocumentSnapshot document) async {
