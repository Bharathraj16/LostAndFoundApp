          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Bigtext(
                    text: "Have you Lost an item and you want to Find it?",
                  ),
                ),
                Space(),
                Center(
                ...
                Space(),
                _buildTextField(ownercontroller, "Owner Name", TextInputType.text),
                const SizedBox(height: 10),
                _buildTextField(emailcontroller, "Owner Email Address", TextInputType.emailAddress),
                const SizedBox(height: 10),
                _buildTextField(phonenumbercontoller, "Owner Phone number", TextInputType.number),
                const SizedBox(height: 10),
